...
// DELETE ROUTES
// Removes a row from the inventory and the vendor_has_inventory tables
router.delete('/inventory/:row', function (req, res, next) {
    var delete1 = 'DELETE FROM inventory WHERE inventory_id = ' + req.params.row;
    var delete2 = 'DELETE FROM Vendor_has_Inventory WHERE inventory_id = ' + req.params.row;
    async.parallel([
        function (parallel_done) {
